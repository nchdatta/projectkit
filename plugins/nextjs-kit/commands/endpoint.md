...
2. **Validation** — `src/lib/validations/<resource>.ts`: zod schemas per mutating operation, plus list query params. No barrel file — import the module directly (`react-performance.md` rule 4).
